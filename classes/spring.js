...
export class Spring {
    ...
    // m1:Mass
    // m2: Mass
    k = 0.05; //this is the spring  constant too big and the model is unstable and too small and the model is not stiff enough   0.1 is a good start point
    restLength = 0;
    broken = false;
    index = 0;
    ...
    stretch(game) {
        ...
        let direction = this.a.position
            .subtract(this.b.position)
            .normalise();
        let extension = this.a.position.distanceFrom(this.b.position) - this.restLength;
    ...
    distanceFrom(p) {
        ...
        let closestPoint = new Vector(p.x, 0);
