...
export class Game {
    ...
    ctx;
    isActive = false;
    mouseDownPoint = new Vector(0, 0);
    mouseUpPoint = new Vector(0, 0);
    ...
    saveLevel() {
        ...
        localStorage.setItem(document.getElementById("saveInput").value, JSON.stringify(this));
    }
    async loadLevel() {
